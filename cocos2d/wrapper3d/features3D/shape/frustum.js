pc.extend(pc, function () {
     ...
     * @param {cc.Mat4} projectionMatrix The projection matrix describing the shape of the frustum.
     * @param {cc.Mat4} viewMatrix The inverse of the world transformation matrix for the frustum.
     */
    var Frustum = function Frustum(projectionMatrix, viewMatrix) {
        projectionMatrix = projectionMatrix || new cc.Mat4().setPerspective(90, 16 / 9, 0.1, 1000);
        viewMatrix = viewMatrix || new cc.Mat4();
    ...
    Frustum.prototype = {
         ...
         * @param {cc.Vec3} point The point to test
