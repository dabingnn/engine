            ...
            if (this.skinInstance) {
                ...
                if (!this.mesh.boneAabb) {
                    ...
                    for (i = 0; i < numBones; i++) {
                        boneMin[i] = new cc.Vec3(Number.MAX_VALUE, Number.MAX_VALUE, Number.MAX_VALUE);
                        boneMax[i] = new cc.Vec3(-Number.MAX_VALUE, -Number.MAX_VALUE, -Number.MAX_VALUE);
                    }
