...
pc.extend(pc, function () {
    ...
    var velocityVec = new cc.Vec3();
    var localVelocityVec = new cc.Vec3();
    var velocityVec2 = new cc.Vec3();
    var localVelocityVec2 = new cc.Vec3();
    var rndFactor3Vec = new cc.Vec3();
    var particlePosPrev = new cc.Vec3();
    var particlePos = new cc.Vec3();
    var particleFinalPos = new cc.Vec3();
    var moveDirVec = new cc.Vec3();
    var rotMat = new cc.Mat4();
    var spawnMatrix3 = new cc.Mat3();
    var emitterMatrix3 = new cc.Mat3();
    var uniformScale = 1;
    var nonUniformScale;
    var spawnMatrix = new cc.Mat4();
    var randomPos = new cc.Vec3();
    var randomPosTformed = new cc.Vec3();
    var tmpVec3 = new cc.Vec3();
    var velocityV = new cc.Vec3();
    var bMin = new cc.Vec3();
    var bMax = new cc.Vec3();
    ...
    var ParticleEmitter = function (graphicsDevice, options) {
        ...
        setProperty("emitterExtents", new cc.Vec3(0, 0, 0));        // Spawn point divergence
        ...
        this.frameRandom = new cc.Vec3(0, 0, 0);
        ...
        this.lightCubeDir[0] = new cc.Vec3(-1, 0, 0);
        this.lightCubeDir[1] = new cc.Vec3(1, 0, 0);
        this.lightCubeDir[2] = new cc.Vec3(0, -1, 0);
        this.lightCubeDir[3] = new cc.Vec3(0, 1, 0);
        this.lightCubeDir[4] = new cc.Vec3(0, 0, -1);
        this.lightCubeDir[5] = new cc.Vec3(0, 0, 1);

        this.animParams = new cc.Vec4();
        ...
        this.worldBoundsSize = new cc.Vec3();
        this.prevWorldBoundsSize = new cc.Vec3();
        this.prevWorldBoundsCenter = new cc.Vec3();
        this.worldBoundsMul = new cc.Vec3();
        this.worldBoundsAdd = new cc.Vec3();
        this.timeToSwitchBounds = 0;
        //this.prevPos = new cc.Vec3();
    ...
    ParticleEmitter.prototype = {
        ...
        rebuildGraphs: function () {
            ...
            this.localVelocityUMax = new cc.Vec3(0, 0, 0);
            this.velocityUMax = new cc.Vec3(0, 0, 0);
            this.colorUMax = new cc.Vec3(0, 0, 0);
            this.rotSpeedUMax = [0];
            this.scaleUMax = [0];
            this.alphaUMax = [0];
        ...
        resetMaterial: function () {
            ...
            material.setParameter("emitterScale", cc.Vec3.ONE.data);
                    ...
                    if (particleEnabled) {
                        ...
                        if (this.initialVelocity > 0) {
                            if (this.emitterShape === pc.EMITTERSHAPE_SPHERE) {
                                randomPos.copy(rndFactor3Vec).scale(2).sub(cc.Vec3.ONE).normalize();
                                localVelocityVec.add(randomPos.scale(this.initialVelocity));
                            } else {
                                localVelocityVec.add(cc.Vec3.FORWARD.scale(this.initialVelocity));
                            }
                        }
