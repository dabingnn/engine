cc3d.extend(cc3d, function () {
    function InterpolatedKey() {
        ...
        this._quat = new cc.Quat();
        this._pos = new cc.Vec3();
        this._scale = new cc.Vec3();
    ...
    /**
     * @function
     * @name cc3d.Skeleton#blend
     * @description Blends two skeletons together.
     * @param {cc3d.Skeleton} skel1 Skeleton holding the first pose to be blended.
     * @param {cc3d.Skeleton} skel2 Skeleton holding the second pose to be blended.
     ...
     * @deprecated
     * @function
     * @name cc3d.Skeleton#getAnimation
     * @description Returns the animation currently assigned to the specified skeleton.
     * @returns {cc3d.Animation} The animation set on the skeleton.
     * @author Will Eastcott
     */
    ...
    /**
     * @name cc3d.Skeleton#currentTime
     * @type Number
     ...
     * @deprecated
     * @function
     * @name cc3d.Skeleton#getCurrentTime
     ...
     * @deprecated
     * @function
     * @name cc3d.Skeleton#setCurrentTime
     ...
     * @deprecated
     * @function
     * @name cc3d.Skeleton#getNumNodes
     ...
     * @deprecated
     * @function
     * @name cc3d.Skeleton#setAnimation
     * @description Sets an animation on the specified skeleton.
     * @param {cc3d.Animation} animation The animation to set on the skeleton.
     * @author Will Eastcott
     */
    ...
    /**
     * @function
     * @name cc3d.Skeleton#updateGraph
