...
Mat4.prototype = {
    ...
    setLookAt: (function () {
        ...
        x = new cc3d.math.Vec3();
        y = new cc3d.math.Vec3();
    ...
    getTranslation: function (t) {
        t = (t === undefined) ? new cc3d.math.Vec3() : t;
     ...
     */
    getX: function (x) {
        x = (x === undefined) ? new cc3d.math.Vec3() : x;
     ...
     */
    getY: function (y) {
        y = (y === undefined) ? new cc3d.math.Vec3() : y;
     ...
     */
    getZ: function (z) {
        z = (z === undefined) ? new cc3d.math.Vec3() : z;
    ...
    getScale: (function () {
        ...
        return function (scale) {
            scale = (scale === undefined) ? new cc3d.math.Vec3() : scale;
    ...
    setFromEulerAngles: function (ex, ey, ez) {
        ...
        ex *= cc3d.math.DEG_TO_RAD;
        ey *= cc3d.math.DEG_TO_RAD;
        ez *= cc3d.math.DEG_TO_RAD;
    ...
    getEulerAngles: (function () {
        var scale = new cc3d.math.Vec3();

        return function (eulers) {
            var x, y, z, sx, sy, sz, m, halfPi;

            eulers = (eulers === undefined) ? new cc3d.math.Vec3() : eulers;
            ...
            return eulers.set(x, y, z).scale(cc3d.math.RAD_TO_DEG);
        };
    }()),
