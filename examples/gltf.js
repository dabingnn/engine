...
function initScene () {
    ...
    gltf.loader.loadFont(fontFile, fontImage, function (err, data) {
        ...
        labelMesh = cc3d.createMesh(cc.renderer.device, positions, {uvs: uvs, normals: normals, indices: indices});
    ...
    gltf.loader.loadScene(url, function (err, scene) {
        ...
        node = new cc.Node3D();
        node.setLocalPosition(new cc.Vec3(-20.34,8.49,-32));
