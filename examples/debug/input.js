...
class Input {
    ...
    _initEvents() {
        ...
        this._canvasKeydownHandle = event => {
            event.stopPropagation();
        ...
        this._canvasKeyupHandle = event => {
            event.stopPropagation();
            this._keyStates[event.key] = KEY_UP;
        };

        this._canvasMousedownHandle = event => {
            event.stopPropagation();
        ...
        this._canvasMouseenterHandle = event => {
            event.stopPropagation();
        ...
        this._canvasMouseleaveHandle = event => {
            event.stopPropagation();
        ...
        // handle keyboard
        canvasEL.addEventListener('keydown', this._canvasKeydownHandle);
        canvasEL.addEventListener('keyup', this._canvasKeyupHandle);

        // handle mouse
        canvasEL.addEventListener('mousedown', this._canvasMousedownHandle);
        canvasEL.addEventListener('mouseenter', this._canvasMouseenterHandle);
        canvasEL.addEventListener('mouseleave', this._canvasMouseleaveHandle);
    ...
    destroy () {
        ...
        canvasEL.removeEventListener('keyup', this._canvasKeyupHandle);

        // handle mouse
        canvasEL.removeEventListener('mousedown', this._canvasMousedownHandle);
        canvasEL.removeEventListener('mouseenter', this._canvasMouseenterHandle);
        canvasEL.removeEventListener('mouseleave', this._canvasMouseleaveHandle);

        canvasEL.removeEventListener('mousemove', this._mousemoveHandle);
        canvasEL.removeEventListener('mousewheel', this._mousewheelHandle);
